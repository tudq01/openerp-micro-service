...
const initialFormState = { progress: 0, status: "NOT_STARTED", type: "DEPARTMENT" };

const ModalAddTargetTeam = ({ isOpen, handleSuccess, handleClose }) => {
        ...
        keyResults: z
          .array(
            z.object({
              ...
              weighted: z.number().optional().nullable(),
              progress: z.number({
                required_error: "This field is required",
                invalid_type_error: "This field is required",
              }),
...
export default ModalAddTargetTeam;
