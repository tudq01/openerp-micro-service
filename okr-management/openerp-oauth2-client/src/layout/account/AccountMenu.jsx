          ...
          >
            <Paper elevation={0} sx={styles.paper}>
              <ClickAwayListener onClickAway={handleClose}>
                <MenuList id={id} autoFocusItem={open.get()} onKeyDown={handleListKeyDown}>
                  <li style={menuItemWrapperStyles}>
                    <Box display="flex" pl={1} pr={1} alignItems="center">
                      ...
                      >
                        {token.name?.split(" ").pop().substring(0, 1).toLocaleUpperCase()}
                      </Avatar>
                  ...
                  {menuItems.map(({ text, subheader, topDivider, onClick, icon }, index) =>
                    topDivider ? (
