...
menuIconMap.set("Department", <BiBuilding size={24} />);
menuIconMap.set("Team", <BiGroup size={24} />);
menuIconMap.set("ApartmentSharpIcon", <ApartmentSharpIcon />);

menuIconMap.set("Teaching", <img alt="Teaching icon" src={TeachingIcon} height={24} width={24} />);
...
menuIconMap.set("HomeSharpIcon", <GroupsIcon />);
...
menuIconMap.set("LocalLibraryIcon", <TrackChangesIcon />);
