...
const TeamScreen = () => {
  ...
  const { data } = useQuery({
    queryKey: ["user-targets-teams-member", filterParams],
    queryFn: async () => {
      ...
      const teams = await request("GET", `/targets/team`, null, errorHandlers, null, {
        params: { ...filterParams, teamId: res.data.teamId, type: "DEPARTMENT" },
      });
      return teams.data;
    },
  ...
  //   enabled: true,
  // });
  // const userOptions = users?.employees?.length
    ...
    <>
      <div className="flex flex-col gap-3">
        <div className="flex flex-row justify-between">
          <h1 className="text-2xl text-600">My Team Targets</h1>
