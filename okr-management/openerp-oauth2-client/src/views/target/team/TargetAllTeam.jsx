...
const TargetAllTeamScreen = () => {
  ...
  const { data } = useQuery({
    ...
    queryFn: async () => {
      ...
      const teams = await request("GET", `/targets/team`, null, errorHandlers, null, {
        params: { ...filterParams, teamId: id, type: "DEPARTMENT" },
      });
      return teams.data;
    },
  ...
  const { data: users } = useQuery({
    ...
    queryFn: async () => {
      const res = await request("GET", `/teams/members`, null, null, null, { params: { teamId: id } });
...
export default TargetAllTeamScreen;
